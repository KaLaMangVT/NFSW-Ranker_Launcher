...
namespace GameLauncher.App.Classes.LauncherCore.Visuals
{
    class Theming
    {
        private static readonly string ThemeFolder = AppDomain.CurrentDomain.BaseDirectory + "ธีม";
        ...
        public static string ThemeName = "พื้นฐาน";

        public static string ThemeAuthor = "ตัวเปิดเกมโดย - Division";
