    ...
    public partial class WelcomeScreen : Form
    {
        ...
        private void GameLangSource_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    GameLangSource.SelectedIndex = 10;
                    return;
                }
            }
            catch { }
        ...
        {
            ListStatusText.Text = "Server API - Online";

            if (!VisualsAPIChecker.UnitedAPI())
            {
                ListStatusText.Text = "Server API 2 - Online";

                if (!VisualsAPIChecker.CarbonAPI())
                {
                    ListStatusText.Text = "Server API 3 - Online";
            ...
            if (StatusCheck)
            {
                WelcomeText.Text = "ดูเหมือนว่า Game Launcher ไม่สามารถเข้าถึง API ของเราได้\n" +
                    "การคลิก 'Manual Bypass' จะทำให้คุณสามารถข้ามขั้นตอนนี้ได้ แต่ก็อาจจะเกิดปัญหาขึ้นอีกในภายหลัง";
            ...
            else
            {
                ...
                WelcomeText.Text = "ไงเพื่อน!\n" +
                    "ดูเหมือนว่านี่จะเป็นครั้งแรกที่นายได้ก้าวเข้ามาที่แห่งนี้ อย่างไรก็ดี\n" +
                    "นายจะต้องตระหนักอยู่เสมอว่า การแข่งรถบนถนนสาธารณะนั้น\n" +
                    "\n'ผิดกฎหมาย!'\n\n" +
                    "แต่แน่นอนว่าไม่ใช่สำหรับที่นี่...\n" +
                    "หากเข้าใจแล้วก็เลือกภาษาของเกมและ CDN\nเพื่อดาวน์โหลดตัวเกมได้เลย!";
            }
        }
